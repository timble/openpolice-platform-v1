        ...
        switch ($task) {
            ...
            case 'edit':
                ...
                foreach ($scripts as $script) {
                    $this->document->addScript(JURI::root() . '/administrator/components/com_jce/media/js/' . $script . '?version=' . $model->getVersion());
                }

				$this->document->addScript(JURI::root() . '/components/com_jce/editor/libraries/js/colorpicker.js?version=' . $model->getVersion());
				$this->document->addScript(JURI::root() . '/components/com_jce/editor/libraries/js/select.js?version=' . $model->getVersion());
