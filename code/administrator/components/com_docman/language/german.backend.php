<?php
/**
 * @version		$Id: german.backend.php 11 2009-10-22 12:58:14Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
define('_DML_UPLOADMETHOD', "Wählen Sie die Methode zum Hochladen");
define('_DML_ISUPLOADING', "Die Datei wird hochgeladen...");
define('_DML_PLEASEWAIT', "Bitte warten...");
define('_DML_UPLOADDISK', "Upload-Assistent - Laden Sie eine Datei von einem Datenträger hoch");
define('_DML_FILETOUPLOAD', "Bitte wählen Sie eine Datei zum Hochladen aus");
define('_DML_BATCHMODE', "Batch-Modus");
define('_DML_BATCHMODETT', "Im Batch-Modus können Sie eine Zip-Archiv hochladen, dass mehrere Dateien enthalten kann. Das Archiv wird nach dem Hochladen automatisch entpackt. Bitte sorgen Sie dafür, dass das Archiv keine zusätzlichen Archive oder Unterordner enthält. Bedenken Sie, dass dieser Prozess bereits im DOCman-Verzeichnis enthaltene Dateien ohne jede Warung überschreiben wird, wenn sie den gleichen Dateinamen haben. Dieser Modus ist noch im experimentier Status, also seinen Sie vorsichtig mit dieser Funktion.");
define('_DML_DOCMANISTRANSF', "Die Datei wird<br />übertragen");
define('_DML_TRANSFERFROMWEB', _DML_UPLOADWIZARD . " - " . "übertragen Sie eine Datei von einem Server");
define('_DML_REMOTEURL', "Externe URL");
define('_DML_LINKURLTT', "Geben Sie eine externen Link zu Ihrer Datei ein. Der Link muss ein Protokoll beinhalten (http:// oder ftp://), den Dateinamen und dessen Dateityp. Zum Beispiel: http://www.beispiel.de/datei.zip.");
...
define('_DML_LOCALNAMETT', "Geben Sie den lokalen Namen für die externe Datei ein."
     . "Dieses Feld müssen Sie ausfüllen, da nur der Link nicht genügend Informationen über die Datei liefert.");
...
define('_DML_SELECTMETHODFIRST', "Bitte wählen Sie eine Transfermethode aus!");
...
define('_DML_MAKE_SELECTION', "Bitte wählen Sie zuerst einen Eintrag von der Liste!");
...
define('_DML_YOU_MUST_UPLOAD', "Sie müssen erst ein Dokument für diese Kategorie hochladen!");
...
define('_DML_MAKE_SURE', "Stellen Sie sicher, dass die URL mit 'http://' beginnt.");
define('_DML_DOCURL', "URL des Dokuments");
define('_DML_DOCURL_TOOLTIP', "Wenn Sie verlinkte Dokumente haben, dann müssen Sie die vollständige Adresse für das Dokument eingeben. Denken Sie an das Protokoll (&quot;http://&quot; oder &quot;ftp://&quot;) am Anfang der URL!");
...
define('_DML_DISPLAY_LIC_TOOLTIP', "Wählen Sie &quot;Ja&quot;, wenn Sie wollen, dass die Lizenz angezeigt wird, bevor der Benutzer Zugriff bekommt.");
...
define('_DML_PLEASE_SEL_CAT', "Bitte wählen Sie zuerst min. eine Kategorie aus!");
...
define('_DML_SELECT_ITEM_DEL', "W?hlen Sie etwas zum L?schen aus!"); // No Enties
define('_DML_SELECT_ITEM_MOVE', "W?hlen Sie etwas zum Verschieben aus!"); // No Enties
define('_DML_SELECT_ITEM_COPY', "W?hlen Sie etwas zum Kopieren aus!"); // No Enties
...
define('_DML_CREATEMENUITEM', "Dieses wird einen neuen Menüeintrag in dem von Ihnen gewählten Men&uuml erstellen.");
define('_DML_SELECTMENU', "Wählen Sie ein Menü");
define('_DML_SELECTMENUTYPE', "Wählen Sie ein Menütyp");
define('_DML_MENUITEMNAME', "Menüeintragsname");
define('_DML_SELECTCATTO', "Wählen Sie eine Kategorie um");
define('_DML_SELECTCATTODELETE', "Wählen Sie eine Kategorie zum Löschen aus!");
...
define('_DML_ADD_GROUP_TIP', "Klicken Sie doppelt auf einen Namen oder benutzen Sie die Pfeile, um Benutzer hinzuzufügen oder zu löschen. "
...
define('_DML_FILL_FORM', "Bitte füllen Sie das Formular korrekt aus!");
...
define('_DML_CFG_PATHTT', "Hier sollten Sie das lokale Verzeichnis angeben, wo alle Dateien gespeichert werden sollen. Geben Sie einen absoluten Pfad an! Sie können den Standard-Pfad benutzen oder Sie tragen einen eigenen hier ein.<br /><br />"
     . "Zum Beispiel: Auf einem &quot;NIX-System&quot; könnte das so aussehen: &quot;/var/usr/www/dmdocuments&quot;<br /><br />"
     . "Wenn Sie einen Windows basierenden Server benutzen, könnte das so aussehen: &quot;c:/inetpub/www/dmdocuments&quot;");
define('_DML_CFG_SECTIONISDOWN', "DOCman gesperrt?");
define('_DML_CFG_SECTIONTT', "Wenn Sie normale Benutzer vom Zugang zu den Downloads ausschließen wollen, dann stellen Sie diese Option auf &quot;Ja&quot;. <br />"
     . "Dieses ist sinnvoll, wenn Sie testen oder die Downloads aktualisieren wollen.<br /><br />"
...
define('_DML_CFG_VIEWTT', "Hier können Sie den Standard-Benutzer bzw. die Standard-Gruppe eintragen, die ein Dokument anzeigen darf. Diese Einstellung kann in jedem Dokument überschrieben werden.");
define('_DML_CFG_MAINTAIN', "Verwaltung");
define('_DML_CFG_MAINTAINTT', "Hier können Sie den Standard-Benutzer bzw. die Standard-Gruppe eintragen, die ein Dokument verwalten darf. Diese Einstellung kann in jedem Dokument überschrieben werden.");
define('_DML_CFG_CREATORS_PERM', "Ersteller können");
define('_DML_CFG_CREATORSPERMTT', "Hier können Sie allgemein einstellen, was ein Ersteller eines Dokumentes darf.<br /><br />"
...
define('_DML_CFG_WHOCANAREADERTT', "Hier können Sie einstellen, ob ein Ersteller/Verwalter die Anzeigeberechtigung seines Dokuments ändern kann.<br /><br />"
     . "Hinweis: Administratoren können immer die Anzeigeberechtigungen verändern!");
define('_DML_CFG_WHOCANAEDITOR', "Bearbeiten");
define('_DML_CFG_WHOCANAEDITORTT', "Hier können Sie einstellen, ob der Ersteller/Verwalter die Verwaltungsberechtigung ändern kann.<br /><br />"
...
define('_DML_CFG_UPLOADTT', "Hier können Sie den Benutzer bzw. die Gruppe wählen, die Dokumente hochladen darf. Diese Funktion beinhaltet alle Hochlademethoden: http, Link und Transfer.");
define('_DML_CFG_APPROVE', "Freigabe");
define('_DML_CFG_APPROVETT', "Hier können Sie den Benutzer bzw. die Gruppe wählen, die Dokumente freigeben dürfen.<br />Dokumente müssen freigegeben und veröffentlicht werden, bevor sie verfügbar sind.");
define('_DML_CFG_PUBLISH', "Veröffentlichung");
define('_DML_CFG_PUBLISHTT', "Hier können Sie den Benutzer bzw. die Gruppe wählen, die Dokumente veröffentlichen dürfen.<br />Dokumente müssen freigegeben und veröffentlicht werden, bevor sie verfügbar sind.");
...
define('_DML_CFG_MAXFILESIZETT', "Die maximale Dateigröße beim Hochladen im Frontend. Sie können K/M/G (<b>K</b>ilobyte/<b>M</b>egabyte/<b>G</b>igabyte) als Shortcuts für diesen Eintrag benutzen.<br />Dieses Limit betrifft das Hochladen im Backend nicht!<br /><hr />Es gibt auf Ihrem Server eine PHP-Variable, upload_max_filesize, sie steht auf ");
define('_DML_CFG_USERCANUPLOAD', "Benutzer dürfen alle Dateitypen hochladen?");
define('_DML_CFG_USERCANUPLOADTT', "Wenn &quot;Ja&quot; und &quot;Benutzer dürfen hochladen&quot;, dann können registrierte Benutzer alle Dateitypen hochladen, egal was Sie oben ausgeschlossen haben!");
...
define('_DML_CFG_FILENAMEBLANKSTT', "Behandlung von Dateinamen mit Leerzeichen:<br />"
     ...
     . "Sie können auch die Dateinamen in Unterstriche (_), Bindestriche (-) konvertieren oder Sie lassen sie entfernen.");
define('_DML_CFG_REJECTFILENAMES', "Abgelehnte Dateinamen");
define('_DML_CFG_REJECTFILENAMESTT', "Geben Sie hier eine Liste von Dateinamen an, durch &quot;|&quot; getrennt, die nicht hochgeladen werden dürfen. Diese Dateinamen haben z.B. spezielle Aufgaben im System. &quot;.htaccess&quot; wird standardmäßig abgelehnt.<br />Sie können auch andere Namen angeben, die zu Problemen auf Ihrem System führen würden, wie z.B. *, ), $, ? oder (");
define('_DML_CFG_UPMETHODS', "Upload-Methoden?");
define('_DML_CFG_UPMETHODSTT', "Wählen Sie hier die Methoden zum Hochladen aus, die dem Benutzer zur Verfügung stehen sollen. Administratoren können allen Methoden nutzen! Mehrere Methoden auswählen mit: " . _DML_MULTIPLE_SELECTS);

define('_DML_CFG_ANTILEECH', "Anti-Leech-System?");
define('_DML_CFG_ANTILEECHTT', "Das Anti-Leech-System schützt Ihre Downloads vor dem Verlinken von anderen Seiten auf Ihre Dokumente. "
     . "Wenn Sie diese Einstellung auf &quot;Ja&quot; stellen, so wird jede Anfrage auf einen Download, "
     ...
     . "Dieses System schützt Sie davor, dass andere Betreiber Ihr Downloadverzeichnis ausnutzen.<br /><br />"
     . "Hinweis: DOCman unterstützt das direkte Verlinken zwischen Systemen. "
     . "Wenn Sie Links benutzen, dann stellen Sie vorher sicher, dass der andere Betreiber Sie in der Liste erlaubter Hosts eingetragen hat."
    );
define('_DML_CFG_ALLOWEDHOSTS', "Erlaubte Hosts");
define('_DML_CFG_ALLOWEDHOSTSTT', "Eine Liste von Hosts, die bei aktiviertem Anti-Leech-System auf Ihre Dokumente zugreifen dürfen. Bitte trennen Sie mehrere Systeme durch ein &quot;|&quot;.<br />Die Standardeinstellung ist im allgemeinen sicher.");
...
define('_DML_CFG_ERR_UPLOAD', 'Tab [' . _DML_PERMISSIONS . '] \'' . _DML_CFG_UPLOAD . '\': Geben Sie ein, wer Dokumente hochladen darf.');
define('_DML_CFG_ERR_APPROVE', 'Tab [' . _DML_PERMISSIONS . '] \'' . _DML_CFG_APPROVE . '\': Geben Sie ein, wer Dokumente freigeben darf.');
define('_DML_CFG_ERR_DOWNLOAD', 'Tab [' . _DML_PERMISSIONS . '] \'' . _DML_CFG_VIEW . '\': Wählen Sie die Standard Benutzer/Gruppe.');
define('_DML_CFG_ERR_EDIT', 'Tab [' . _DML_PERMISSIONS . '] \'' . _DML_CFG_MAINTAIN . '\': Wählen Sie die Standard Benutzer/Gruppe zum Verwalten des Dokuments aus.');
...
define('_DML_CFG_PROCESS_BOTSTT', "Durch diese Funktion können Mambots auf Dokumenten- und Kategoriebeschreibungen angewand werden. Dieses erlaubt Ihnen &quot;{Tags}&quot; in Beschreibungen zu nutzen. Warnung: Nicht alle Mambots arbeiten reibungslos mit dieser Funktion!");
define('_DML_CFG_INDIVIDUAL_PERM', "Individuelle Benutzerberechtigungen erlauben?");
define('_DML_CFG_INDIVIDUAL_PERMTT', "Wenn Sie diese Einstellung deaktivieren, so werden Sie zwar weiterhin in der Lage sein Berechtigungen einer Gruppe zuzuweisen, aber nicht mehr einem einzelnen Benutzer. Ihre bestehenden Dokument-Berechtigungen werden erhalten bleiben, aber wenn ein Dokument bearbeitet wird, dass einem einzelnen Benutzer zugeteilt ist, so muss dann eine Benutzergruppe ausgewählt werden. Schalten Sie diese Funktion aus, wenn Sie die Geschwindigkeit und die Speicherkapazität steigern möchten.");
...
define('_DML_YOU_HAVE_VERSION', "Sie haben die Version");
define('_DML_UPTODATE', "Ihre Version ist aktuell!");
define('_DML_NO_UP_AVAIL', "Keine Updates zum jetzigen Zeitpunkt verfügbar!");
define('_DML_COULD_NOT_COPY', "Es konnten nicht alle Dateien zu ihren Verzeichnissen kopiert werden! Überprüfen Sie die Dateiberechtigungen! Gestoppt bei der Datei");
...
define('_DML_SELECT_DIRECTORY', "Bitte geben Sie ein Verzeichnis an!");
define('_DML_SELECT_PACKAGE', "Bitte wählen Sie ein Paket!");
...
define('_DML_SAMPLE_CATEGORY_DESC', "Sie können die Beispielkategorie löschen." );
define('_DML_SAMPLE_DOC', "Beispieldokument" );
define('_DML_SAMPLE_DOC_DESC', "Sie können das Beispieldokument und die verlinkte Datei löschen." );
...
define('_DML_SAMPLE_GROUP_DESC', "Sie können Gruppen dazu nutzen um bestimmten Gruppen von Benutzern Rechte zu geben." );
define('_DML_SAMPLE_LICENSE', "Beispiellizenz" );
define('_DML_SAMPLE_LICENSE_DESC', "Sie können optional Lizenzen zu einem Dokument anzeigen lassen." );
