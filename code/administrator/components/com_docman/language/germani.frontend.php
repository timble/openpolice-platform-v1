<?php
/**
 * @version		$Id: germani.frontend.php 11 2009-10-22 12:58:14Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
// -- General
define('_DML_NOLOG', "Du musst Dich anmelden, damit Du die verfügbaren Dokumente anzeigen kannst!");
define('_DML_NOLOG_UPLOAD', "Du musst angemeldet und für das Hochladen von Dokumenten freigeschalten sein!");
define('_DML_NOLOG_DOWNLOAD', "Du musst angemeldet und Rechte zum Anzeigen dieses Dokumentes haben!");
...
define('_DML_ISDOWN', "Entschuldigung, aber dieser Bereich ist wegen Wartungsarbeiten gesperrt. Bitte komme später wieder.");
...
define('_DML_THANKSDOCMAN', "Danke für Deine Übermittlung!");
...
define('_DML_YOU_MUST_UPLOAD', "Du musst erst ein Dokument in dieser Kategorie anlegen!");
...
define('_DML_MAKE_SURE', "Stelle sicher, dass der Link mit 'http://' beginnt.");
define('_DML_DOCURL', "URL des Dokuments:");
define('_DML_DOCDELETED', "Dokument gelöscht.");
define('_DML_DOCURL_TOOLTIP', "Wenn Du verlinkte Dokumente hast, dann musst Du die vollständige Adresse für das Dokument eingeben. Denke an das Protokoll (http:// oder ftp://) am Anfang!");
...
define('_DML_DISPLAY_LIC_TOOLTIP', "Wähle &quot;Ja&quot;, wenn Du willst, dass die Lizenz dem Benutzer vor dem Zugriff auf den Download angezeigt wird.");
...
// -- Download
define('_DML_PROCEED', "Klicke hier, um fortzufahren");
define('_DML_YOU_MUST', "Du musst der Lizenz zustimmen, bevor Du dieses Dokument ansehen kannst!");
define('_DML_NOTDOWN', "Das Dokument wird gerade bearbeitet bzw. aktualisiert und ist deshalb momentan nicht zu erreichen!");
define('_DML_ANTILEECH_ACTIVE', "Du versuchst über eine nicht autorisierte Adresse dieses Dokument einzusehen!");
...
define('_DML_LINKURLTT', "Gebe eine externen Link zu Deiner Datei ein. Der Link muss ein Protokoll beinhalten (http:// oder ftp://), den Dateinamen und dessen Dateityp. Zum Beispiel: http://joomlacode.org/gf/download/frsrelease/292/1001/docman_1.3RC2.zip.");
...
define('_DML_LOCALNAMETT', "Gebe den lokalen Namen für die externe Datei ein."
     . "Dieses Feld musst Du ausfüllen, da nur der Link nicht genügend Informationen über die Datei gibt.");
