 ...
 */
class AvReloadedModelPlayer extends JModel
{
    /**
    ...
    function &getData() {
        // Load the data
        if (empty($this->_data)) {
            $query = 'SELECT * FROM #__avr_player WHERE id = '.$this->_id;
    ...
    function store() {
        $row =& $this->getTable();
        // Must allow raw request here, because player code
        // contains html and scripting
