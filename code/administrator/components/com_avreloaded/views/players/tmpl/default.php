...
<div id="editcell">
    ...
    <thead>
        <tr>
            ...
            <th class="title">
                <?php echo JHTML::_('grid.sort', 'Description', 'p.description', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
            </th>
			<th width="5%">
...
for ($i = 0, $n = count($this->items); $i < $n; $i++) {
    ...
    $link = JRoute::_('index.php?option=com_avreloaded&controller=players&task=edit&cid[]='.$row->id);
?>
