...
<div id="editcell">
    ...
    <thead>
        <tr>
            ...
            <th class="title">
                <?php echo JHTML::_('grid.sort', 'Description', 'r.description', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
            </th>
			<th width="5%">
				<?php echo JHTML::_('grid.sort', 'Used', 'used', @$this->lists['order_Dir'], @$this->lists['order']);?>
            </th>
        </tr>
    </thead>
    <tfoot>
...
for ($i = 0, $n = count($this->items); $i < $n; $i++) {
    ...
    $link = JRoute::_('index.php?option=com_avreloaded&controller=rippers&task=edit&cid[]='.$row->id);
?>
...
<input type="hidden" name="view" value="rippers" />
