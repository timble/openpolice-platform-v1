...
class PhocaGalleryCpModelPhocaGalleryCoImgs extends JModel
{
	...
	function _buildContentOrderBy() {
		...
		if ($filter_order == 'a.ordering'){
			$orderby 	= ' ORDER BY imgtitle, a.ordering '.$filter_order_Dir;
		} else {
			$orderby 	= ' ORDER BY '.$filter_order.' '.$filter_order_Dir.' , imgtitle, a.ordering ';
		}
