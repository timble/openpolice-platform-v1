		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="15%"  class="title">
						<?php echo JHTML::_('grid.sort',  'Image', 'imagetitle', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			...
			<tbody>
				...
				for ($i=0, $n=count( $this->items ); $i < $n; $i++)
				{
					...
					$catLink 	= JRoute::_( 'index.php?option=com_phocagallery&controller=phocagalleryc&task=edit&cid[]='. $row->categoryid );
					$imgLink 	= JRoute::_( 'index.php?option=com_phocagallery&controller=phocagallery&task=edit&cid[]='. $row->imageid );
				?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<td><a href="<?php echo $imgLink; ?>" title="<?php echo JText::_( 'Edit Image' ); ?>"><?php echo $row->imagetitle; ?></a>
					</td>

					<td><a href="<?php echo $catLink; ?>" title="<?php echo JText::_( 'Edit Category' ); ?>"><?php echo $row->categorytitle; ?></a>
					</td>
...
<input type="hidden" name="controller" value="phocagalleryraimg" />
