		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th class="title" width="30%"><?php echo JHTML::_('grid.sort',  'Title', 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>
			...
			<tbody>
				...
				for ($i=0, $n=count( $this->items ); $i < $n; $i++)
				{
					...
					$link 			= JRoute::_( 'index.php?option=com_phocagallery&controller=phocagalleryco&task=edit&cid[]='. $row->id );
...
<input type="hidden" name="controller" value="phocagalleryco" />
