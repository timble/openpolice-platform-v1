	...
	<tr>
		<td align="center" valign="middle" height="486"><?php
			if (isset($this->file->extid) && $this->file->extid !='') {
				...
				echo '<a href="#" onclick="window.parent.document.getElementById(\'sbox-window\').close();">'. JHTML::_('image', JURI::root(false, '').substr($this->file->linkthumbnailpath, 1).'?imagesid='.md5(uniqid(time())), '').'</a>';
			}
			?>
		</td>
	</tr>
