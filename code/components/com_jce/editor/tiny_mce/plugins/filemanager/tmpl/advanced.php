...
?>
			<table border="0" cellpadding="0" cellspacing="4" class="properties" width="100%">
				...
				<tr>
					<td><label for="class" class="hastip" title="<?php echo WFText::_('WF_LABEL_CLASSES_DESC');?>"><?php echo WFText::_('WF_LABEL_CLASSES');?></label></td>
					<td><input type="text" id="class" value="" onchange="AdvLinkDialog.setPopup(this);" /></td>
				</tr>
				<tr>
