 ...
 * JCEMediaBox 1.0.12
 *
 * @version 		$Id: jcemediabox.js 887 2010-10-15 17:01:40Z happynoodleboy $
 * @package 		JCEMediaBox
...
(function() {
    ...
    JCEMediaBox.Popup = {
		 ...
		 */
		process : function(el) {
			var DOM = JCEMediaBox.DOM, o = {}, p = {}, group, auto;
        ...
        change: function(n) {
            ...
            switch (this.active.type) {
                case 'image':
					...
					if (isIE) {
						DOM.style(this.content, 'background-color', '#FFFFFF');
					}
        ...
        setup: function() {
            ...
            if (this.active.type == 'image') {
				...
				if (JCEMediaBox.isIE) {
					DOM.style(DOM.get('jcemediabox-popup-img'), '-ms-interpolation-mode', 'bicubic');
				}
            }
