...
class plgEditorJCE extends JPlugin
{
    ...
    function onInit()
    {
        ...
        $document->addScript(JURI::root(true).'/plugins/editors/jce/tiny_mce/tiny_mce'.$gzip.'.js?version='.$version.'&cid='.$component->id);
	...
	function onGetInsertMethod($name)
	{
	    ...
	    $js = "JContentEditor.setBookmark('".$name."');function jInsertEditorText(text,editor){JContentEditor.insert(editor,text);}";
