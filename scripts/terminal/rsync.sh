...
/usr/local/bin/rsync -avz --delete --iconv=UTF8-MAC,UTF8 -e "ssh -p 9999" --no-links --exclude-from 'rsync.exclude' deploy@127.0.10.10:/var/www/v2.lokalepolitie.be/ /Users/terminal/Sites/v2.lokalepolitie.be/backups/files/
